...
\author{
    郑皓 \\ 姚书璟\\ 罗斯
    \and
    学号：23336328  \\ 学号：23336286 \\ 学号：xxx
    \and
    班级：9 \\ 班级：8 \\ 班级：9
}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{update_test.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{join_test.png}
    \caption{JOIN 测试结果截图}
    \label{fig:join_test}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{unique_index_success.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{unique_index_fail.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{subquery_test.png}
    \caption{子查询测试结果截图}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{alias_test.png}
    \caption{别名测试结果截图}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{drop-table-test.png}
    \caption{别名测试结果截图}
    \label{fig:alias_test}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{order-by-test.png}
    \caption{别名测试结果截图}
    \label{fig:alias_test}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{null-test.png}
    \caption{别名测试结果截图}
    \label{fig:alias_test}
\end{figure}
