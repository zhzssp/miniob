...
public:
  ...
  RC create_index(Trx *trx, vector<const FieldMeta *> field_meta, const char *index_name) override { return RC::UNIMPLEMENTED; }
  ...
  Index *find_index_by_field(vector<string> field_names) const override { return nullptr; }
  RC     open() override;
  RC    close() override;
